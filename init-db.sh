...
echo 'CREATE DATABASE testing_db_ecs;' | psql "host=terraform-20230826235006805200000003.cbsvfiw8swkk.us-east-1.rds.amazonaws.com port=5432 dbname=postgres user=my_db_user password=DXR4
dHphensTn4ct"